...
public class ProfileActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mActionBar.setTitle(nickname);
		mActionBar.setDisplayHomeAsUpEnabled(true);
		
		System.out.println("프로필 사진 뷰 시작 " + id);
		...
		switch (item.getItemId()) {
			case R.id.photo_save:
				...
				if (result) {
					...
					// alert_msg.setText("저장이 완료되었습니다.");
				} else {
					makeToastMsg("저장 실패하였습니다.");
					// alert_msg.setText("저장 실패하였습니다.");
				}
	...
	public void getPhoto(String filename) {
		...
		String dir = file.getAbsolutePath() + "/profile/large";
	...
	class DownloadThread extends Thread {
		...
		DownloadThread(String serverPath, String localPath) {
			ServerUrl = HOST + "/profile/large/" + serverPath;
			LocalPath = localPath;
			imagePath = LocalPath;
		}
